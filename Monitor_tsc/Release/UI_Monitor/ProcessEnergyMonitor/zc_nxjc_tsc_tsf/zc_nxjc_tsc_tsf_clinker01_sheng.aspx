...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/zc_nxjc_tsc_tsf_clinker01_sheng.png'); width: 1350px; height: 740px; overflow: hidden;">
     <!--石灰石皮带电机117.05 -->
         <table class="mytable" style="position: absolute; top: 289px; left: 21px; height: 53px; right: 1263px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBeltMotor>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBeltMotor>Current" class="mchart nodisplay"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBeltMotor>Power" class="mchart"></span></td>
            </tr>
        </table>
     <!--210.12入磨皮带 -->
 ...
 <!--拉链机311.13 -->
        ...
        <table class="mytable" style="position: absolute; top: 101px; left: 296px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBrokenBelt>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBrokenBelt>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBrokenBelt>Power" class="mchart"></span></td>
            </tr>
        </table>
<!-- 石灰石板喂机110.01 -->
        <table class="mytable" style="position: absolute; top: 20px; left: 229px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneFeedingMachine>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneFeedingMachine>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneFeedingMachine>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 给料辊110.02 -->
        <table class="mytable" style="position: absolute; top: 21px; left: 296px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>feedingRoller>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>feedingRoller>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>feedingRoller>Power" class="mchart"></span></td>
            </tr>
        </table>
         <!-- 收尘风机110.05 -->
        <table class="mytable" style="position: absolute; top: 179px; left: 21px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>dustCollectingFan05>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>dustCollectingFan05>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>dustCollectingFan05>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 石灰石皮带117.01 -->
        <table class="mytable" style="position: absolute; top: 98px; left: 365px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt01>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt01>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt01>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 石灰石皮带110.03 -->
        <table class="mytable" style="position: absolute; top: 100px; left: 229px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt03>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt03>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneBelt03>Power" class="mchart"></span></td>
            </tr>
        </table>
          <!-- 石灰石取料刮板117.02 -->
        <table class="mytable" style="position: absolute; top: 179px; left: 229px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneStacker>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneStacker>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>limestoneStacker>Power" class="mchart"></span></td>
            </tr>
        </table>
  <!-- 粘土破120.01a -->
        <table class="mytable" style="position: absolute; top: 271px; left: 429px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken1>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken1>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken1>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 粘土破120.01b -->
        <table class="mytable" style="position: absolute; top: 269px; left: 511px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken2>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken2>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>clayBroken2>Power" class="mchart"></span></td>
            </tr>
        </table>
         <!-- 石灰石破碎主电机 -->
        <table class="mytable" style="position: absolute; top: 19px; left: 367px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>crusher>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>crusher>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>crusher>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 均化库罗茨风机220.15 -->
  ...
  <!-- 离心通风机110.08M -->
        <table class="mytable" style="position: absolute; top: 178px; left: 297px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>centrifugalFan08>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>centrifugalFan08>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf>centrifugalFan08>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!-- 窑尾袋除尘器控制柜 -->

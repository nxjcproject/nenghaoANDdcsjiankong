...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--标签粘贴处--%>
       ...
       <%--开关量--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A1ALC_FT>BoolSignal" style="position: absolute; top:527px; left: 1223px; height: 18px; width: 24px;" data-option="RelatedTags='Clinker02_A1ALC_FT',Display='000:grayS,001:redSB'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A11ALC_FT>BoolSignal" style="position: absolute; top:199px; left: 467px; height: 18px; width: 24px;" data-option="RelatedTags='Clinker02_A11ALC_FT',Display='000:grayS,001:redSB'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_B55ALC_AM>BoolSignal" style="position: absolute; top:621px; left: 1173px; height: 18px; width: 24px;" data-option="RelatedTags='Clinker02_B55ALC_AM,Clinker02_B55ALC_RN,Clinker02_B55ALC_RD2',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_B55ALC_FT>BoolSignal" style="position: absolute; top:627px; left: 1180px; height: 7px; width: 13px;" data-option="RelatedTags='Clinker02_A11ALC_FT',Display='000:grayS,001:redSB'"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT01_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 325px; left: 464px; position: absolute; color: blue; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT02_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 325px; left: 622px; position: absolute; color: blue; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT04_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 323px; left: 781px; position: absolute; color: blue; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT03_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 323px; left: 941px; position: absolute; color: blue; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A8M_LW_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 324px; left: 1101px; position: absolute; color: blue; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A4M_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 557px; left: 427px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A4M_ZFLJL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 579px; left: 430px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A7M_ZFLJL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 578px; left: 605px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A5M_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 558px; left: 754px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A5M_ZFLJL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 581px; left: 761px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A6M_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 558px; left: 899px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A6M_ZFLJL>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 45px; display: block; top: 580px; left: 906px; position: absolute; color: #4cff00; text-align: right; height: 19px;"></div>

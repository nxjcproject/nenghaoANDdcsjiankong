...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_efc/zc_nxjc_qtx_efc_cementmill03_snfm.png'); width: 1480px; height: 760px; overflow: hidden;">
    <%--标签粘贴处--%>
    <%--模拟量--%>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M56M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 179px; left: 104px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 1322px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M51AC_WT01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 297px; left: 256px; position: absolute; color: blue; text-align: right; height: 22px; right: 1170px;"></div>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_GZ0202_GIR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 53px; display: block; top: 591px; left: 345px; position: absolute; color: #4cff00; text-align: right; height: 17px; right: 1082px;"></div>
 

            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M47M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 46px; left: 465px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 961px;"></div>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M42AC_SR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 44px; display: block; top: 126px; left: 670px; position: absolute; color: #4cff00; text-align: right; height: 16px; right: 766px; bottom: 618px;"></div>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M29AC_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 44px; display: block; top: 291px; left: 663px; position: absolute; color: #4cff00; text-align: right; height: 16px; right: 773px; "></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE3_38R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 313px; left: 660px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 777px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M29AC_SR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 333px; left: 656px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 781px;"></div>
  
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTT341R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 44px; display: block; top: 254px; left: 892px; position: absolute; color: #4cff00; text-align: right; height: 16px; right: 544px; bottom: 490px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MPT302R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 274px; left: 891px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 546px;"></div>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE308R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 51px; display: block; top: 544px; left: 706px; position: absolute; color: #4cff00; text-align: right; height: 21px; "></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE304R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 51px; display: block; top: 545px; left: 832px; position: absolute; color: #4cff00; text-align: right; height: 21px; right: 597px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_AI_M35MR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 51px; display: block; top: 575px; left: 776px; position: absolute; color: #4cff00; text-align: right; height: 21px; right: 653px;"></div>
    
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE310R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 51px; display: block; top: 601px; left: 705px; position: absolute; color: #4cff00; text-align: right; height: 21px; right: 724px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE3_42R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 51px; display: block; top: 602px; left: 831px; position: absolute; color: #4cff00; text-align: right; height: 21px; right: 598px;"></div>


            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LIE2SR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 44px; display: block; top: 149px; left: 1012px; position: absolute; color: #4cff00; text-align: right; height: 16px; right: 424px; bottom: 595px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE3_36R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 170px; left: 1011px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 426px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTE3_30R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 190px; left: 1010px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 427px;"></div>

            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M32M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 45px; left: 1396px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 41px;"></div>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MTT303R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 44px; display: block; top: 256px; left: 1277px; position: absolute; color: #4cff00; text-align: right; height: 16px; right: 159px; bottom: 488px;"></div>
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MPT304R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 43px; display: block; top: 277px; left: 1278px; position: absolute; color: #4cff00; text-align: right; height: 18px; right: 159px;"></div>

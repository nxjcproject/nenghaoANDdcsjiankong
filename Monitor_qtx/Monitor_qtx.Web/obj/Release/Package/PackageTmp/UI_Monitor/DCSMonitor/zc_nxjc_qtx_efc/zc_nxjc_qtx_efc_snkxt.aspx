...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
  ...
  <%--贴标签处--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT09_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 111px; position:absolute;color:blue;text-align:right; bottom: 540px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT10_RDCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 250px; position:absolute;color:blue;text-align:right; bottom: 541px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT11_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 390px; position:absolute;color:blue;text-align:right; bottom: 542px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_NYSNK6_PZ>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:47px; display:block; left: 247px; position:absolute;color:blue;text-align:right; bottom: 488px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT04_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 78px; position:absolute;color:blue;text-align:right; bottom: 260px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT03_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 210px; position:absolute;color:blue;text-align:right; bottom: 261px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT02_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 343px; position:absolute;color:blue;text-align:right; bottom: 260px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:47px; display:block; left: 477px; position:absolute;color:blue;text-align:right; bottom: 261px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT05_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 867px; position:absolute;color:blue;text-align:right; bottom: 260px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT06_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 1002px; position:absolute;color:blue;text-align:right; bottom: 262px; height: 18px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT07_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 1133px; position:absolute;color:blue;text-align:right; bottom: 261px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT08_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:52px; display:block; left: 1263px; position:absolute;color:blue;text-align:right; bottom: 264px; height: 18px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M34M_I_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; left: 678px; position:absolute;color:#4cff00;text-align:right; bottom: 616px; height: 20px;"></div>
        <%--开关量--%>

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--标签粘贴处--%>
      <%--开关量--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_4AC1_RD>BoolSignal" style="position: absolute; top: 286px; left: 192px; height: 26px; width: 26px;" data-option="RelatedTags='Cement01_L_4AC1_RD,Cement01_L_4AC1_RN,Cement01_L_4AC1_ALMR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_4AC2_RD>BoolSignal" style="position: absolute; top: 286px; left: 267px; height: 26px; width: 26px;" data-option="RelatedTags='Cement01_L_4AC2_RD,Cement01_L_4AC2_RN,Cement01_L_4AC2_ALMR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_15M_RD>BoolSignal" style="position: absolute; top: 145px; left: 698px; height: 28px; width: 28px;" data-option="RelatedTags='Cement01_L_15M_RD,Cement01_L_15M_RN,Cement01_L_15M_ALM',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_5M_RD>BoolSignal" style="position: absolute; top: 559px; left: 1340px; height: 26px; width: 26px;" data-option="RelatedTags='Cement01_L_5M_RD,Cement01_L_5M_RN,Cement01_L_5M_ALM',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LLIA_01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 427px; left: 103px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 1323px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_LA_02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 427px; left: 175px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 1251px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_IA_03R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 428px; left: 248px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 1178px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_LIA_01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 290px; left: 576px; position: absolute; color: blue; text-align: right; height: 22px; right: 850px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_LIA_02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 289px; left: 759px; position: absolute; color: blue; text-align: right; height: 22px; "></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_LIA_03R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 290px; left: 936px; position: absolute; color: blue; text-align: right; height: 22px; right: 490px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_L_II_04R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 120px; left: 1249px; position: absolute; color: #4cff00; text-align: right; height: 22px; right: 177px;"></div>

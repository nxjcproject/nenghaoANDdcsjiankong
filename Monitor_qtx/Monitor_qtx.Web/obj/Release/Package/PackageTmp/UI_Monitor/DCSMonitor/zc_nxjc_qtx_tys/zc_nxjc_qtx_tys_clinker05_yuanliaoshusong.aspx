...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_clinker05_yuanliaoshusong.png'); width: 1558px; height: 809px; overflow: hidden;">
       <%--<button onclick="CheckTags()">检查标签</button>--%>
         <%--模拟量--%>
          ...
          <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y21000L02_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:60px; display:block; top:449px; left: 978px;  position:absolute;color:blue;text-align:right; height: 16px;"></div>
          ...
          <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13201AC3_SD_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:60px; display:block; top:220px; left: 390px;  position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
          ...
          <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13301_I_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:43px; display:block; top:396px; left: 218px;  position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
          ...
          <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13304_I_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:48px; display:block; top:639px; left: 473px;  position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
          ...
          <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y21013W01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:58px; display:block; top:685px; position:absolute;color:#4cff00;text-align:right; height: 16px; right: 190px;"></div>
     ...
     <%--开关量圆图--%>  
             ...
             <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y21013W01_RD>BoolSignal" style="position: absolute; top:708px; left: 1333px; height: 21px; width: 21px;" data-option="RelatedTags='dcs02_Y21013W01_RD,dcs02_Y21013W01_RN,dcs02_Y21013W01_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
      ...
      <%--开关量方图--%> 
            ...
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13204AC_RD>BoolSignal" style="position: absolute; top:57px; left: 96px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13204AC_RD,dcs02_Y13204AC_RN,dcs02_Y13204AC_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13206AC_RD>BoolSignal" style="position: absolute; top:57px; left: 435px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13206AC_RD,dcs02_Y13206AC_RN,dcs02_Y13206AC_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
           
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13211AC_RD>BoolSignal" style="position: absolute; top:367px; left: 151px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13211AC_RD,dcs02_Y13211AC_RN,dcs02_Y13211AC_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y21002_RD>BoolSignal" style="position: absolute; top:126px; left: 1273px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y21002_RD,dcs02_Y21002_RN,dcs02_Y21002_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13306_RD>BoolSignal" style="position: absolute; top:561px; left: 545px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13306_RD,dcs02_Y13306_RN,dcs02_Y13306_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13308_RD>BoolSignal" style="position: absolute; top:638px; left: 629px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13308_RD,dcs02_Y13308_RN,dcs02_Y13308_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
            <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs02_Y13209AC_RD>BoolSignal" style="position: absolute; top:250px; left: 569px; height: 20px; width: 20px;" data-option="RelatedTags='dcs02_Y13209AC_RD,dcs02_Y13209AC_RN,dcs02_Y13209AC_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
    ...
    <%--文字报警--%>
              <div id="zc_nxjc_qtx_tys>dcs02_W320012_OK>DCS" class="TextDisplay" style="font-size: 8.0pt;color:white;position:absolute; top: 254px; left: 78px;  "data-option="Display='0'">离合器位置</div>

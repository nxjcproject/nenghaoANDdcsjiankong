...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_22000L01>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:43px; display:block; top: 213px; left: 903px; position:absolute;color:#4cff00;text-align:right; height: 19px; font-size: medium;"></div>   
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_221_11_1>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:38px; display:block; top: 72px; left: 268px; position:absolute;color:#4cff00;text-align:right; height: 14px; font-size: small;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_01_1>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:38px; display:block; top: 55px; left: 1096px; position:absolute;color:#4cff00;text-align:right; height: 15px; font-size: small;"></div>
...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_06B>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:48px; display:block; top: 552px; left: 748px; position:absolute;color:#4cff00;text-align:right; height: 16px; font-size: small;"></div>
...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_15>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:49px; display:block; top: 532px; left: 1337px; position:absolute;color:#4cff00;text-align:right; height: 16px; font-size: small;"></div>
...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_16>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:49px; display:block; top: 607px; left: 1336px; position:absolute;color:#4cff00;text-align:right; height: 16px; font-size: small;"></div>
...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_221_16>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:49px; display:block; top: 700px; left: 1335px; position:absolute;color:#4cff00;text-align:right; height: 16px; font-size: small;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_09C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 202px; left: 1303px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div> 
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_10C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 292px; left: 1355px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_11C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 381px; left: 1311px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_12C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 381px; left: 1236px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_13C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 300px; left: 1185px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_14C>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 204px; left: 1236px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<%--<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker03_AI1_220_09C_1>DCS" data-option="Alarm=',,,',Range='Max,Min'" style="width:35px; display:block; top: 279px; left: 771px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>--%> 
 <%--重复的模拟量--%>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_09C>DCS'"style="width:35px; display:block; top: 279px; left: 771px; position:absolute;color:blue;text-align:right; height: 18px; font-size: medium;"></div>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_10C>DCS'"style="width:35px; display:block; top: 336px; left: 773px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_11C>DCS'"style="width:35px; display:block; top: 390px; left: 771px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_12C>DCS'"style="width:35px; display:block; top: 391px; left: 523px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_13C>DCS'"style="width:35px; display:block; top: 336px; left: 523px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
<div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Clinker03_AI1_220_14C>DCS'"style="width:35px; display:block; top: 279px; left: 523px; position:absolute;color:#4cff00;text-align:right; height: 18px; font-size: medium;"></div>
                            
      <%--汉字隐藏--%>

<div id="zc_nxjc_qtx_efc>Clinker03_DI3_421_06>DCS" class="TextDisplay" style="position:absolute; top: 297px; left: 221px; color:red;text-align:center; height: 13px; width: 51px; font-size: small;">速度</div>  

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_cementmill04_snpl.png');width: 1557px; height: 807px;  overflow: hidden;">
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N52007_RD>BoolSignal" style="position: absolute; top:170px; left: 1192px; height: 17px; width: 16px;" data-option="RelatedTags='dcs01_N52007_RD,dcs01_N52007_RN,dcs01_N52007_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N34302_RD>BoolSignal" style="position: absolute; top:440px; left: 201px; height: 17px; width: 13px;" data-option="RelatedTags='dcs01_N34302_RD,dcs01_N34302_RN,dcs01_N34302_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N34503_RD>BoolSignal" style="position: absolute; top:596px; left: 368px; height: 18px; width: 18px;" data-option="RelatedTags='dcs01_N34503_RD,dcs01_N34503_RN,dcs01_N34503_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N34504_RD>BoolSignal" style="position: absolute; top:594px; left: 397px; height: 13px; width: 14px;" data-option="RelatedTags='dcs01_N34504_RD,dcs01_N34504_RN,dcs01_N34504_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N55002_RN2>BoolSignal" style="position: absolute; top:391px; left: 1057px; height: 20px; width: 21px;" data-option="RelatedTags='dcs01_N55002_RD,dcs01_N55002_RN2,dcs01_N55002_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N55002_RN1>BoolSignal" style="position: absolute; top:161px; left: 56px; height: 27px; width: 29px;" data-option="RelatedTags='dcs01_N55002_RD,dcs01_N55002_RN1,dcs01_N55002_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N55017_RD>BoolSignal" style="position: absolute; top:694px; left: 1405px; height: 7px; width: 40px;" data-option="RelatedTags='dcs01_N55017_RD,dcs01_N55017_RN,dcs01_N55017_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N55101_RD>BoolSignal" style="position: absolute; top:452px; left: 1454px; height: 14px; width: 15px;" data-option="RelatedTags='dcs01_N55101_RD,dcs01_N55101_RN,dcs01_N55101_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_N55001b_RD>BoolSignal" style="position: absolute; top:298px; left: 1210px; height: 18px; width: 23px;" data-option="RelatedTags='dcs01_N55001b_RD,dcs01_N55001b_RN,dcs01_N55001b_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_SN_SUM1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:42px; display:block; top: 732px; left: 488px; position:absolute;color:#4cff00;text-align:right"></div>
        ...
        <%--汉字隐藏--%>
        <div id="zc_nxjc_qtx_tys>dcs01_N52002AR_SO>DCS" class="TextDisplay" style="position:absolute; top: 160px; left: 356px; text-align:center;font-size:12px">破碎机启动完毕 </div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N52006_SS>DCS" class="TextDisplay" style="position:absolute; top: 205px; left: 480px; text-align:center">速度信号 </div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N52007_SS>DCS" class="TextDisplay" style="position:absolute; top: 173px; left: 861px; text-align:center;font-size:12px; height: 13px;">速度信号 </div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N52007_LS>DCS" class="TextDisplay" style="position:absolute; top: 174px; left: 1000px; color:red;text-align:center;font-size:12px; width: 26px;">拉绳</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N52007_PS1>DCS" class="TextDisplay" style="position:absolute; top: 174px; left: 1041px; color:red;text-align:center;font-size:12px; height: 12px; width: 35px;">跑偏1</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N52007_PS2>DCS" class="TextDisplay" style="position:absolute; top: 174px; left: 1084px; color:red;text-align:center;font-size:12px; width: 36px;">跑偏2</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34501_ZLM>DCS" class="TextDisplay" style="position:absolute; top: 268px; left: 355px; text-align:center; height: 15px; width: 16px;">开 </div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34501_FLM>DCS" class="TextDisplay" style="position:absolute; top: 308px; left: 355px; text-align:center; height: 16px; width: 16px;">关</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N550SL2_RN>DCS" class="TextDisplay" data-option="Display=0" style="position:absolute; top: 441px; left: 638px; text-align:center">开</div>
        <%--<div id="zc_nxjc_qtx_tys>dcs01_N550SL2_RN>DCS" class="TextDisplay" style="position:absolute; top: 440px; left: 670px; text-align:center">关</div>--%>  
        <div id="zc_nxjc_qtx_tys>dcs01_N550SL1_RN>DCS" class="TextDisplay" data-option="Display=0" style="position:absolute; top: 359px; left: 731px; text-align:center; height: 15px; width: 16px;">开 </div>  
        <%--<div id="zc_nxjc_qtx_tys>dcs01_N550SL1_RN>DCS" class="TextDisplay" style="position:absolute; top: 160px; left: 343px; text-align:center">关</div>--%>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55001a_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 279px; left: 1150px; text-align:center">开</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55001a_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 309px; left: 1151px; text-align:center">关</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55001b_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 332px; left: 1201px; text-align:center">开</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55001b_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 332px; left: 1230px; text-align:center">关</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34302_QDZ>DCS" class="TextDisplay" style="position:absolute; top: 463px; left: 203px; text-align:center;font-size:12px; height: 13px; width: 39px;">启动中</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34302_FL>DCS" class="TextDisplay" style="position:absolute; left: 251px; color:red;text-align:center;font-size:12px; top: 463px; height: 14px; width: 26px; margin-right: 0px;">故障</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34302_LS>DCS" class="TextDisplay" style="position:absolute; top: 463px; left: 282px; color:red;text-align:center;font-size:12px; height: 15px; width: 26px; right: 1249px;">拉绳</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34302_SE>DCS" class="TextDisplay" style="position:absolute; top: 463px; left: 315px; color:red;text-align:center;font-size:12px; height: 16px; width: 32px;">跑偏1</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34302_SS>DCS" class="TextDisplay" style="position:absolute; top: 463px; left: 357px; text-align:center;font-size:12px; height: 14px;">速度信号</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34502_SE>DCS" class="TextDisplay" style="position:absolute; top: 405px; left: 441px; color:red;text-align:center;font-size:12px; height: 12px; width: 35px;">跑偏1</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N34502_LS>DCS" class="TextDisplay" style="position:absolute; top: 434px; left: 441px; color:red;text-align:center;font-size:12px; width: 27px;">拉绳</div> 
        <div id="zc_nxjc_qtx_tys>dcs01_N34502_SS>DCS" class="TextDisplay" style="position:absolute; top: 461px; text-align:center;font-size:12px; height: 16px;">速度信号</div>  
        ...
        <div id="zc_nxjc_qtx_tys>dcs01_N55012_CP>DCS" class="TextDisplay" style="position:absolute; top: 642px; left: 768px; text-align:center;font-size:12px; height: 12px; width: 53px;">累计脉冲 </div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55013_CP>DCS" class="TextDisplay" style="position:absolute; top: 643px; left: 1008px; text-align:center;font-size:12px">累计脉冲</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55014_CP>DCS" class="TextDisplay" style="position:absolute; top: 643px; left: 1166px; text-align:center;font-size:12px">累计脉冲</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55015_CP>DCS" class="TextDisplay" style="position:absolute; top: 644px; left: 1316px; text-align:center;font-size:12px">累计脉冲</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55002_SS>DCS" class="TextDisplay" style="position:absolute; top: 394px; left: 1230px; text-align:center;font-size:12px; height: 15px; width: 58px;">速度信号</div>  
        <div id="zc_nxjc_qtx_tys>dcs01_N55101_SS>DCS" class="TextDisplay" style="position:absolute; top: 501px; left: 1419px; text-align:center;font-size:12px;">速度信号</div>  
        ...
        <div id="zc_nxjc_qtx_tys>dcs01_N55016_SS>DCS" class="TextDisplay" style="position:absolute; top: 780px; left: 1197px; text-align:center;">速度信号</div>  

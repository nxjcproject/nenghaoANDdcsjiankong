...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--标签粘贴处--%>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_L_LIA_01R>DCS'" style="width:46px; display:block; top: 565px; left: 17px; position:absolute;color:#4cff00;text-align:right;"></div>
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_G3M_IIR>DCS'"style="width:46px; display:block; top: 376px; left: 522px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_GZ0201_GIR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 593px; left: 350px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G6M_SIR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 132px; left: 650px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G6M_SKR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 151px; left: 650px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G6M_TIAR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 171px; left: 650px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>

        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_GZZ1_ZIR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 168px; left: 864px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_TIA_03R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 133px; left: 1239px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_PI_02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 158px; left: 1240px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_II_02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 111px; left: 1352px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_TIA_04R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 235px; left: 1030px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_PI_03R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 260px; left: 1032px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_TIA_02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 412px; left: 1020px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_PI_01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 436px; left: 1022px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_TIA_43R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 600px; left: 1034px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_PI43R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 622px; left: 1035px; position:absolute;color:#4cff00;text-align:right; height: 16px;"></div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_L_15M_SE1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 435px; left: 6px; color: #4cff00; text-align: center; height: 22px; right: 1217px; bottom: 120px;">Ⅰ度跑偏</div>
        <div id="zc_nxjc_qtx_efc>Cement01_L_15M_SE2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 493px; left: 8px; color: #4cff00; text-align: center; height: 22px; right: 1217px; bottom: 65px;">Ⅱ度跑偏</div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_M_16ALC_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 687px; left: 920px; color: #4cff00; text-align: center; height: 18px; right: 334px; bottom: 71px;">故障</div>

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--李烨--%>
  <%--模拟量--%>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_Q14AC_SF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 139px; left: 944px; position:absolute;color:#4cff00;text-align:right;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_Q11M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 178px; left: 879px; position:absolute;color:red;text-align:right;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_Q14AC_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 178px; left: 1102px; position:absolute;color:red;text-align:right;"></div>
...
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_QTE02_T_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 439px; left: 804px; position:absolute;color:#4cff00;text-align:right;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_A13M_CUN_A>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 512px; left: 756px; position:absolute;color:#4cff00;text-align:right;"></div>
<div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT01_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:36px; display:block; top: 615px; left: 837px; position:absolute;color:blue;text-align:right;"></div>
          <%--开关量 圆--%>
...
<div id="zc_nxjc_qtx_efc>Clinker02_Q9M_SS1>DCS" class="TextDisplay" style="position:absolute; top: 297px; left: 817px; color:red;text-align:center;font-size:12px">速度报警</div> 
 <div id="zc_nxjc_qtx_efc>Clinker02_Q11ALP_LK>DCS" class="TextDisplay" style="position:absolute; top: 232px; left: 814px; color:yellow;text-align:center;font-size:12px">允许启动</div>
        <%--棒图--%>
<%-- <div class="BarGraph mchart" id="zc_nxjc_qtx_efc>Clinker02_ALT01_L_M>DCS"  style="border-style: solid; border-color: inherit; border-width: 1px; width:11px; height:71px; position:absolute; top: 621px; left: 813px;"></div>--%>
    </div>
</body>
</html>
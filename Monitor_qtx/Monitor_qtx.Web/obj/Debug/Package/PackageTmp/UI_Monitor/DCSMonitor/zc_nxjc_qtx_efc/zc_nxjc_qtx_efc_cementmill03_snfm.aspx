...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--模拟量--%>
            ...
            <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M51AC_WT01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 54px; display: block; top: 302px; left: 252px; position: absolute; color: blue; text-align: right; height: 22px; right: 1174px;"></div>

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_efc/zc_nxjc_qtx_efc_clinker02_sljhk.png'); width: 1480px; height: 760px; overflow: hidden;">
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_B4M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 43px; left: 1132px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F9LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 260px; left: 531px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F4LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 260px; left: 783px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F8LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 320px; left: 530px; position: absolute; color: blue"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F5LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 320px; position: absolute; color: blue; left: 782px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F7LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 376px; left: 529px; position: absolute; color: blue; right: 911px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F6LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 376px; left: 785px; position: absolute; color: blue"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F26AC_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 558px; left: 796px; position: absolute; color: #4cff00; height: 16px;"></div>

        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F37M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 507px; left: 1360px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F38M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 603px; left: 1356px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F39M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 683px; left: 1357px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F45AC_FF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 605px; left: 452px; position: absolute; color: #4cff00"></div>
        ...
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F6LP_ZF_M>DCS'" style="width: 40px; display: block; top: 362px; position: absolute;"></div>

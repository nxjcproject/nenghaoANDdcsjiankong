    ...
    <%--标签粘贴处--%>
      <%--模拟量--%>
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_LLT01R>DCS'" style="width:47px; display:block; top: 282px; left: 528px; color: blue; position:absolute;"></div>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LI8M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 563px; left: 1393px; position: absolute; color: #4cff00; text-align: right;"></div>

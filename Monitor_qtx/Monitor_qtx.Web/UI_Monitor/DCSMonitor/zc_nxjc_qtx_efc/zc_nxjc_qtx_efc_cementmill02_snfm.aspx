...
<%--        <button onclick="CheckTags()">检查标签</button>--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_15ALC_RD>BoolSignal" style="position: absolute; top:610px; left: 130px; height: 12px; width: 18px;" data-option="RelatedTags='Cement01_M_15ALC_RD,Cement01_M_15ALC_RNN,Cement01_M_15ALC_ALM',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_DI1_M43ALC>BoolSignal" style="position: absolute; top:690px; left: 661px; height: 12px; width: 18px;" data-option="RelatedTags='Cement01_DI1_M43ALC,Cement01_DI2_M43ALC,Cement01_M43ALC_ALM',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_M_11ALC_RD>BoolSignal" style="position: absolute; top:205px; left: 1220px; height: 19px; width: 32px;" data-option="RelatedTags='Cement01_M_11ALC_RD,Cement01_M_11ALC_RN,Cement01_M_11ALC_ALM',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_PI1R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 431px; left: 154px; position:absolute;color:#4cff00;text-align:right;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_TIA_1R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 453px; left: 154px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_G_TIA_5R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 501px; left: 229px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_H_TIA_6R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 538px; left: 229px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_H_TIA_7R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 539px; left: 322px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_G4M_H_TIA_2R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 520px; left: 411px; position:absolute;color:#4cff00;text-align:right;"></div>
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_G3M_IIR>DCS'"style="width:46px; display:block; top: 376px; left: 522px; position:absolute;color:#4cff00;text-align:right;"></div>
        ...
        <%--汉字隐藏--%>
        <div id="zc_nxjc_qtx_efc>Cement01_PBSX>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 198px; left: 248px; color: red; text-align: center; height: 17px; right: 1095px; bottom: 545px;">警告：配比≠%</div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_M_5M_LH>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 446px; left: 1365px; color: red; text-align: center; height: 18px; right: 97px; bottom: 296px;">料位高</div>
        <div id="zc_nxjc_qtx_efc>Cement01_M_2M_LMF>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 127px; left: 1402px; color: #4cff00; text-align: center; height: 18px; right: 53px; bottom: 615px;">正</div>
        <div id="zc_nxjc_qtx_efc>Cement01_M_2M_LMR>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 127px; left: 1446px; color: #4cff00; text-align: center; height: 18px; right: 10px; bottom: 615px;">反</div>
        <div id="zc_nxjc_qtx_efc>Cement01_M_3M_LMF>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 216px; left: 1419px; color: #4cff00; text-align: center; height: 18px; right: 45px; bottom: 526px;">正</div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_M_24M_SS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; font-size: 14px; top: 632px; color: red; text-align: center; height: 22px; right: 316px; bottom: 106px;">速<br /> 度</div>

...
<%--        <button onclick="CheckTags()">检查标签</button>--%>
        ...
        --%>
        <%--模拟量开始--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F27M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 20px; display: block; top: 52px; left: 309px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_B4M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 41px; left: 1132px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F9LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 258px; left: 531px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F4LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 258px; left: 783px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F8LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 317px; left: 530px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_BLT01_L_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 213px; left: 837px; position: absolute; color: blue"></div>

        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F5LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 317px; position: absolute; color: blue; left: 782px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F7LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 373px; left: 529px; position: absolute; color: blue; right: 911px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F6LP_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 373px; left: 785px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_FZZ05_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 557px; left: 545px; position: absolute; color: #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F26AC_ZF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 557px; left: 796px; position: absolute; color: #4cff00; height: 16px;"></div>

        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F37M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 504px; left: 1360px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F38M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 600px; left: 1356px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F39M_CUN_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 680px; left: 1357px; position: absolute; color: red"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F45AC_FF_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 605px; left: 450px; position: absolute; color: #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F45AC_W_M>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 473px; left: 644px; position: absolute; color: yellow"></div>


        <%--重复的模拟量_开始--%>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F9LP_ZF_M>DCS'" style="width: 40px; display: block; top: 176px; left: 1250px; position: absolute;"></div>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F4LP_ZF_M>DCS'" style="width: 40px; display: block; top: 174px; left: 1354px; position: absolute;"></div>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F5LP_ZF_M>DCS'" style="width: 40px; display: block; top: 273px; left: 1386px; position: absolute;"></div>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F6LP_ZF_M>DCS'" style="width: 40px; display: block; top: 361px; position: absolute; left: 1335px;"></div>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F7LP_ZF_M>DCS'" style="width: 40px; display: block; top: 361px; left: 1247px; position: absolute;"></div>
        <div class="Conflict" data-option="id='zc_nxjc_qtx_efc_clinker02>clinker02_F8LP_ZF_M>DCS'" style="width: 40px; display: block; top: 276px; left: 1192px; position: absolute;"></div>
        <%--重复的模拟量_结束--%>
        <%--模拟量结束--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F43YV1II_RN2>BoolSignal" data-option="RelatedTags='clinker02_F43YV1II_RD,clinker02_F43YV1II_RN2,clinker02_F43YV1II_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 140px; left: 1270px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F41YV1I_RN2>BoolSignal" data-option="RelatedTags='clinker02_F41YV1I_RD,clinker02_F41YV1I_RN2,clinker02_F41YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 140px; left: 1308px; height: 22px; width: 22px;"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F42YV1I_RN2>BoolSignal" data-option="RelatedTags='clinker02_F42YV1I_RD,clinker02_F42YV1I_RN2,clinker02_F42YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 221px; left: 1414px; height: 22px; width: 22px;"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F43YV1I_RN2>BoolSignal" data-option="RelatedTags='clinker02_F43YV1I_RD,clinker02_F43YV1I_RN2,clinker02_F43YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 356px; left: 1392px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F43YV1_RN2>BoolSignal" data-option="RelatedTags='clinker02_F43YV1_RD,clinker02_F43YV1_RN2,clinker02_F43YV1_AM',Display='000:grayC,001:redCB,010:greenCB,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'" style="position: absolute; top: 230px; left: 1268px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F41YV1_RN2>BoolSignal" data-option="RelatedTags='clinker02_F41YV1_RD,clinker02_F41YV1_RN2,clinker02_F41YV1_AM',Display='000:grayC,001:redCB,010:greenCB,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'" style="position: absolute; top: 230px; left: 1312px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F42YV1_RN2>BoolSignal" data-option="RelatedTags='clinker02_F42YV1_RD,clinker02_F42YV1_RN2,clinker02_F42YV1_AM',Display='000:grayC,001:redCB,010:greenCB,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'" style="position: absolute; top: 271px; left: 1334px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F42YV1_RD>BoolSignal" data-option="RelatedTags='clinker02_F42YV1_RD,clinker02_F42YV1_RN2,clinker02_F42YV1_AM',Display='000:grayC,001:redCB,010:greenCB,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'" style="position: absolute; top: 271px; left: 1244px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_FHSB_RN>BoolSignal" data-option="RelatedTags='clinker02_FHSB_RD,clinker02_FHSB_RN',Display='00:grayS,01:redSB,10:yellowSB,11:greenSB'" style="position: absolute; top: 27px; left: 86px; height: 49px; width: 43px;"></div>

        <%--重复的开关量_开始--%>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F43YV1I_RD>BoolSignal" data-option="RelatedTags='clinker02_F43YV1I_RD,clinker02_F43YV1I_RN2,clinker02_F43YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 195px; left: 1173px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F42YV1II_RD>BoolSignal" data-option="RelatedTags='clinker02_F42YV1II_RD,clinker02_F42YV1II_RN2,clinker02_F42YV1II_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 221px; left: 1154px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F42YV1I_RD>BoolSignal" data-option="RelatedTags='clinker02_F42YV1I_RD,clinker02_F42YV1I_RN2,clinker02_F42YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 320px; left: 1158px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F41YV1II_RD>BoolSignal" data-option="RelatedTags='clinker02_F41YV1II_RD,clinker02_F41YV1II_RN2,clinker02_F41YV1II_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 356px; left: 1180px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F41YV1I_RD>BoolSignal" data-option="RelatedTags='clinker02_F41YV1I_RD,clinker02_F41YV1I_RN2,clinker02_F41YV1I_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 403px; left: 1270px; height: 22px; width: 22px;"></div>
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F43YV1II_RD>BoolSignal" data-option="RelatedTags='clinker02_F43YV1II_RD,clinker02_F43YV1II_RN2,clinker02_F43YV1II_AM',Display='000:grayS,001:redSB,010:greenSB,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'" style="position: absolute; top: 403px; left: 1310px; height: 22px; width: 22px;"></div>
        ...
        <%--开关量结束--%>
         <%--液位暂用棒图代替--%>
        <div class="BarGraph mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_F45AC_W_M>BarGraph"  style="border-style: solid; border-color: inherit; border-width: 1px; width:8px; height:53px; position:absolute; top: 449px; left: 715px;"></div>
        <div class="BarGraph mchart" id="zc_nxjc_qtx_efc_clinker02>clinker02_BLT01_L_M>BarGraph"  style="border-style: solid; border-color: inherit; border-width: 1px; width:10px;height:368px; position:absolute; top: 236px; left: 986px;"></div>
    </div>
</body>
</html>

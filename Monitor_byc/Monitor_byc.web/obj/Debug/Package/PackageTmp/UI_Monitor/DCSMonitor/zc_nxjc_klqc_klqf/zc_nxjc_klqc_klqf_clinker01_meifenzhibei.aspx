...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--李伟丽--%>
        ...
        <%--圆形--%>  
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M73_03_RN>BoolSignal" style="position: absolute; top:242px; left: 714px; height: 19px; width: 19px;" data-option="RelatedTags='dcs01_M73_03_YK,dcs01_M73_03_RN,dcs01_M73_03_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>    
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M7702_RD>BoolSignal" style="position: absolute; top:470px; left: 347px; height: 9px; width: 31px;" data-option="RelatedTags='dcs01_M7702_RD,dcs01_M7702_RN,dcs01_M7702_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div> 
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_MM_XYZRN>BoolSignal" style="position: absolute; top:597px; left: 727px; height: 21px; width: 15px;"data-option="RelatedTags='dcs01_MM_KZGRD,dcs01_MM_XYZRN,dcs01_MM_XYZ_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M75_1_RN1>BoolSignal" style="position: absolute; top:324px; left: 988px; height: 20px; width: 20px;"data-option="RelatedTags='dcs01_M75_1_RD,dcs01_M75_1_RN1,dcs01_M75_1_ERR',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div>
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_LIM3>BoolSignal" style="position: absolute; top:284px; left: 711px; height: 20px; width: 21px;" data-option="RelatedTags='dcs01_M73_03_YK,dcs01_SCP73_03_LIM3,dcs01_SCP73_03_LIM4',Display='000:grayS,001:redSB,010:greenS,011:redSB,100:yellowS,101:redS,110:greenS,111:redS'"></div> 
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M70_1_SP_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 16px; left: 139px; position:absolute;color:#4cff00;text-align:right"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M70_1_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 30px; left: 139px; position:absolute;color:#0ff;text-align:right"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_7002_AR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 80px; left: 415px; position:absolute;color:#4cff00;text-align:right"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_1116_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 156px; left: 454px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_7704_AR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 75px; left: 677px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_7300L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 108px; left: 744px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M73_01_R1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:60px; display:block; top: 195px; left: 613px; position:absolute;color:#0ff;text-align:right; height: 16px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TT_7304T06_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 383px; left: 540px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TT_7304T07_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 408px; left: 540px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TT_7304T08_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 432px; left: 540px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M73_4a_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 432px; left: 627px; position:absolute;color:#0ff;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_PT_7304P01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 513px; left: 636px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZT_7313Z01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 525px; left: 533px; position:absolute;color:#0ff;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZT_7314Z01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:27px; display:block; top: 564px; left: 604px; position:absolute;color:#0ff;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TT_7304MT03_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 682px; left: 812px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_PT_7304P06_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 633px; left: 928px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_LT_7304L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 657px; left: 928px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_VT_7304V01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 681px; left: 929px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_WT_7510bW01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:49px; display:block; top: 468px; left: 1108px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_WT_7510aW01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:47px; display:block; top: 471px; left: 1312px; position:absolute;color:blue;text-align:right; height: 15px; right: 123px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_AT_7307A01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 13px; left: 1048px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_7307T04_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 63px; left: 1101px; position:absolute;color:blue;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZT_7310aZ01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 95px; left: 1248px; position:absolute;color:#0ff;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M_73_10HAV_R1>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 167px; left: 1167px; position:absolute;color:#0ff;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_TT_7310MT02_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 167px; left: 1275px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_VT_7310V01_1_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:57px; display:block; top: 167px; left: 1359px; position:absolute;color:#4cff00;text-align:right; height: 15px;"></div>
         <%--汉字隐藏--%>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M77_3_SD>DCS" class="TextDisplay" style="position:absolute; top: 557px; left: 253px; color:#4cff00;text-align:center;font-size:14px">速度信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M77_2_SD>DCS" class="TextDisplay" style="position:absolute; top: 508px; left: 175px; color:#4cff00;text-align:center;font-size:14px">速度信号</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_RHYOK>DCS" class="TextDisplay" style="position:absolute; top: 534px; left: 391px; color:#4cff00;text-align:center;font-size:14px">润滑油条件满足</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG1SW>DCS" class="TextDisplay" style="position:absolute; top: 568px; left: 410px; color:#4cff00;text-align:center;font-size:14px">磨辊1升到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG2SW>DCS" class="TextDisplay" style="position:absolute; top: 590px; left: 408px; color:#4cff00;text-align:center;font-size:14px">磨辊2升到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG3SW>DCS" class="TextDisplay" style="position:absolute; top: 609px; left: 407px; color:#4cff00;text-align:center;font-size:14px; height: 14px; width: 78px;">磨辊3升到位</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_XYZRN>DCS" class="TextDisplay" style="position:absolute; top: 648px; left: 388px; color:#4cff00;text-align:center;font-size:14px">稀油站运行信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_XYZST>DCS" class="TextDisplay" style="position:absolute; top: 672px; left: 389px; color:#4cff00;text-align:center;font-size:14px">稀油站停止信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_JRQRN>DCS" class="TextDisplay" style="position:absolute; top: 692px; left: 362px; color:#4cff00;text-align:center;font-size:14px">稀油站电加热器运行</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_JRQST>DCS" class="TextDisplay" style="position:absolute; top: 714px; left: 363px; color:#4cff00;text-align:center;font-size:14px">稀油站电加热器停止</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_JZYBRN>DCS" class="TextDisplay" style="position:absolute; top: 734px; left: 364px; color:#4cff00;text-align:center;font-size:14px">液压站加载油泵油站</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG1JW>DCS" class="TextDisplay" style="position:absolute; top: 629px; left: 501px; color:#4cff00;text-align:center;font-size:14px; bottom: 110px;">磨辊1降到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG2JW>DCS" class="TextDisplay" style="position:absolute; top: 650px; left: 501px; color:#4cff00;text-align:center;font-size:14px">磨辊2降到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_MG3JW>DCS" class="TextDisplay" style="position:absolute; top: 673px; left: 500px; color:#4cff00;text-align:center;font-size:14px">磨辊3降到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_HXFGW>DCS" class="TextDisplay" style="position:absolute; top: 694px; left: 501px; color:#4cff00;text-align:center;font-size:14px">液动换向阀关到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_HXFKW>DCS" class="TextDisplay" style="position:absolute; top: 714px; left: 502px; color:#4cff00;text-align:center;font-size:14px">液压换向阀开到位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_JZYBST>DCS" class="TextDisplay" style="position:absolute; top: 647px; left: 671px; color:#4cff00;text-align:center;font-size:14px">液压站加载油泵停止</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_YYZJRQRN>DCS" class="TextDisplay" style="position:absolute; top: 669px; left: 672px; color:#4cff00;text-align:center;font-size:14px">液压站加载油泵启动</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_YYZJRQST>DCS" class="TextDisplay" style="position:absolute; top: 689px; left: 671px; color:#4cff00;text-align:center;font-size:14px">液压站电加热器停止</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_FJRN>DCS" class="TextDisplay" style="position:absolute; top: 709px; left: 671px; color:#4cff00;text-align:center;font-size:14px">风机运行信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_FJST>DCS" class="TextDisplay" style="position:absolute; top: 730px; left: 672px; color:#4cff00;text-align:center;font-size:14px">风机停止信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_MM_KZGRD>DCS" class="TextDisplay" style="position:absolute; top: 536px; left: 734px; color:#4cff00;text-align:center;font-size:14px">控制柜备妥</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7314Z01_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 589px; left: 642px; color:#4cff00;text-align:center;font-size:10px">关位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7314Z01_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 545px; left: 653px; color:#4cff00;text-align:center;font-size:10px; bottom: 194px;">开位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_4_2_LHQ>DCS" class="TextDisplay" style="position:absolute; top: 545px; left: 597px; color:#4cff00;text-align:center;font-size:10px">离合器位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7313Z01_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 502px; left: 553px; color:#4cff00;text-align:center;font-size:10px">开位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7313Z01_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 503px; left: 604px; color:#4cff00;text-align:center;font-size:10px">关位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_FT>DCS" class="TextDisplay" style="position:absolute; top: 390px; left: 309px; color:red;text-align:center;font-size:10px">故障</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_HC>DCS" class="TextDisplay" style="position:absolute; top: 377px; left: 310px; color:#4cff00;text-align:center;font-size:10px">换场指示</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_WZ4>DCS" class="TextDisplay" style="position:absolute; top: 361px; left: 309px; color:#4cff00;text-align:center;font-size:10px; bottom: 382px;">二场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_WZ3>DCS" class="TextDisplay" style="position:absolute; top: 348px; left: 309px; color:#4cff00;text-align:center;font-size:10px">一场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_TJYS>DCS" class="TextDisplay" style="position:absolute; top: 331px; left: 310px; color:#4cff00;text-align:center;font-size:10px">取完信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_MA_RD>DCS" class="TextDisplay" style="position:absolute; top: 316px; left: 310px; color:#4cff00;text-align:center;font-size:10px">自动备妥</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_77_01_MM_RD>DCS" class="TextDisplay" style="position:absolute; top: 301px; left: 310px; color:#4cff00;text-align:center;font-size:10px">手动备妥</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_MRD>DCS" class="TextDisplay" style="position:absolute; top: 255px; left: 39px; color:#4cff00;text-align:center;font-size:10px">手动备妥</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_ARD>DCS" class="TextDisplay" style="position:absolute; top: 271px; left: 40px; color:#4cff00;text-align:center;font-size:10px">自动备妥</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_HC>DCS" class="TextDisplay" style="position:absolute; top: 300px; left: 42px; color:#4cff00;text-align:center;font-size:10px">换场指示</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_WZ1>DCS" class="TextDisplay" style="position:absolute; top: 316px; left: 42px; color:#4cff00;text-align:center;font-size:10px">一场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_WZ2>DCS" class="TextDisplay" style="position:absolute; top: 332px; left: 42px; color:#4cff00;text-align:center;font-size:10px">二场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_WZ3>DCS" class="TextDisplay" style="position:absolute; top: 350px; left: 42px; color:#4cff00;text-align:center;font-size:10px">三场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_WZ4>DCS" class="TextDisplay" style="position:absolute; top: 366px; left: 42px; color:#4cff00;text-align:center;font-size:10px">四场位置</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP2302_WZ5>DCS" class="TextDisplay" style="position:absolute; top: 381px; left: 43px; color:#4cff00;text-align:center;font-size:10px">五场位置</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M23_1_SD>DCS" class="TextDisplay" style="position:absolute; top: 261px; left: 164px; color:#4cff00;text-align:center;font-size:10px">速度信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M11_18_SD>DCS" class="TextDisplay" style="position:absolute; top: 195px; left: 398px; color:#4cff00;text-align:center;font-size:10px">速度信号</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M7003_FT>DCS" class="TextDisplay" style="position:absolute; top: 91px; left: 486px; color:red;text-align:center;font-size:10px">故障</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M11_16_SD>DCS" class="TextDisplay" style="position:absolute; top: 121px; left: 432px; color:#4cff00;text-align:center;font-size:10px">速度信号</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M77_4_SD>DCS" class="TextDisplay" style="position:absolute; top: 47px; left: 649px; color:#4cff00;text-align:center;font-size:10px">速度信号</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 193px; left: 745px; color:#4cff00;text-align:center;font-size:10px">开</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 192px; left: 792px; color:#4cff00;text-align:center;font-size:10px">关</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_RN2>DCS" class="TextDisplay" style="position:absolute; top: 266px; left: 749px; color:#4cff00;text-align:center;font-size:10px">清扫电机运行</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_RN3>DCS" class="TextDisplay" style="position:absolute; top: 283px; left: 751px; color:#4cff00;text-align:center;font-size:10px">油泵运行</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_LIM3>DCS" class="TextDisplay" style="position:absolute; top: 280px; left: 695px; color:#4cff00;text-align:center;font-size:10px">开</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP73_03_LIM4>DCS" class="TextDisplay" style="position:absolute; top: 299px; left: 695px; color:#4cff00;text-align:center;font-size:10px">关</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_4a_BP_FS>DCS" class="TextDisplay" style="position:absolute; top: 353px; left: 571px; color:#4cff00;text-align:center;font-size:10px">冷却风扇运行</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_4a_BP_BP>DCS" class="TextDisplay" style="position:absolute; top: 317px; left: 570px; color:#4cff00;text-align:center;font-size:10px">变频运行</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_4a_BP_GP>DCS" class="TextDisplay" style="position:absolute; top: 299px; left: 570px; color:#4cff00;text-align:center;font-size:10px">工频运行</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_5_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 30px; left: 840px; color:#4cff00;text-align:center;font-size:10px">反限位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_5_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 29px; left: 897px; color:#4cff00;text-align:center;font-size:10px">正限位</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_AT_7307A01_RN>DCS" class="TextDisplay" style="position:absolute; top: 75px; left: 943px; color:#4cff00;text-align:center;font-size:10px">CO浓度运行</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_AT_7307A01_QY>DCS" class="TextDisplay" style="position:absolute; top: 95px; left: 942px; color:#4cff00;text-align:center;font-size:10px">CO浓度取样</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_12_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 67px; left: 1184px; color:#4cff00;text-align:center;font-size:10px">正限位</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_12_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 94px; left: 1183px; color:#4cff00;text-align:center;font-size:10px">反限位</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7310aZ01_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 71px; left: 1262px; color:#4cff00;text-align:center;font-size:10px">开位</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_ZT_7310aZ01_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 71px; left: 1315px; color:#4cff00;text-align:center;font-size:10px">关位</div> 
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M_73_10HAV_STB>DCS" class="TextDisplay" style="position:absolute; top: 32px; left: 1364px; color:#4cff00;text-align:center;font-size:10px">待机状态</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M_73_10HAV_GP>DCS" class="TextDisplay" style="position:absolute; top: 46px; left: 1365px; color:#4cff00;text-align:center;font-size:10px">工频状态</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M_73_10HAV_BP>DCS" class="TextDisplay" style="position:absolute; top: 61px; left: 1366px; color:#4cff00;text-align:center;font-size:10px">变频状态</div> 
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_9_SD>DCS" class="TextDisplay" style="position:absolute; top: 174px; left: 998px; color:#4cff00;text-align:center;font-size:10px">速度信号</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M73_8_SD>DCS" class="TextDisplay" style="position:absolute; top: 237px; left: 1015px; color:#4cff00;text-align:center;font-size:10px">速度信号</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_3_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 208px; left: 1130px; color:#4cff00;text-align:center;font-size:10px">开</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_3_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 245px; left: 1130px; color:#4cff00;text-align:center;font-size:10px">关</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_2_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 272px; left: 1287px; color:#4cff00;text-align:center;font-size:10px">开</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_2_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 311px; left: 1289px; color:#4cff00;text-align:center;font-size:10px">关</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_5_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 381px; left: 1177px; color:#4cff00;text-align:center;font-size:10px">开</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_5_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 427px; left: 1176px; color:#4cff00;text-align:center;font-size:10px">关</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_4_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 388px; left: 1350px; color:#4cff00;text-align:center;font-size:10px">开</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_4_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 432px; left: 1353px; color:#4cff00;text-align:center;font-size:10px">关</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_6_LIM1>DCS" class="TextDisplay" style="position:absolute; top: 350px; left: 1393px; color:#4cff00;text-align:center;font-size:10px">开</div> 
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_6_LIM2>DCS" class="TextDisplay" style="position:absolute; top: 392px; left: 1396px; color:#4cff00;text-align:center;font-size:10px">关</div> 
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M75_1_SD>DCS" class="TextDisplay" style="position:absolute; top: 315px; left: 1362px; color:#4cff00;text-align:center;font-size:10px">速度信号</div>  
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_PDS_7304P10>DCS'" style="position:absolute; top: 549px; left: 864px; color:red;text-align:center;font-size:10px">密闭风与一次风压差</div>
         <div id="zc_nxjc_klqc_klqf>dcs01_7304SQ_LIM>DCS" class="TextDisplay" style="position:absolute; top: 626px; left: 657px; color:red;text-align:center;font-size:10px">煤磨盘车限位</div> 
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_WT_7510bW01_FL>DCS" class="TextDisplay" style="position:absolute; top: 522px; left: 1118px; color:red;text-align:center;font-size:10px">称重故障</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_WT_7510aW01_FL>DCS" class="TextDisplay" style="position:absolute; top: 518px; left: 1322px; color:red;text-align:center;font-size:10px">称重故障</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC1_PMT>DCS" class="TextDisplay" style="position:absolute; top: 645px; left: 1043px; color:#4cff00;text-align:center;font-size:10px">允许启动</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC1_GXW>DCS" class="TextDisplay" style="position:absolute; top: 660px; left: 1043px; color:#4cff00;text-align:center;font-size:10px">阀门关限位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC1_KXW>DCS" class="TextDisplay" style="position:absolute; top: 674px; left: 1044px; color:#4cff00;text-align:center;font-size:10px">阀门开限位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC1_XLGZL>DCS" class="TextDisplay" style="position:absolute; top: 692px; left: 1044px; color:#4cff00;text-align:center;font-size:10px">下料管助流动作</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC1_ZLDZ>DCS" class="TextDisplay" style="position:absolute; top: 712px; left: 1044px; color:#4cff00;text-align:center;font-size:10px">仓助流动作</div>  
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC2_PMT>DCS" class="TextDisplay" style="position:absolute; top: 640px; left: 1389px; color:#4cff00;text-align:center;font-size:10px">允许启动</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC2_KXW>DCS" class="TextDisplay" style="position:absolute; top: 656px; left: 1388px; color:#4cff00;text-align:center;font-size:10px">阀门开限位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC2_GXW>DCS" class="TextDisplay" style="position:absolute; top: 675px; left: 1389px; color:#4cff00;text-align:center;font-size:10px">阀门关限位</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_ZZC2_XLGZL>DCS" class="TextDisplay" style="position:absolute; top: 692px; left: 1390px; color:#4cff00;text-align:center;font-size:10px">下料管助流动作</div>  
        <div id="zc_nxjc_klqc_klqf>dcs01_F_3512_FT>DCS" class="TextDisplay" style="position:absolute; top: 713px; left: 1390px; color:#4cff00;text-align:center;font-size:10px">仓助流动作</div> 
         <%--棒图--%>
        <div class="BarGraph mchart" id="zc_nxjc_klqc_klqf>dcs01_F_7300L01_R>BarGraph"  style="border-style: solid; border-color: inherit; border-width: 1px; width:6px; height:43px; position:absolute; top: 105px; left: 726px;"></div> 
        </div>
</body>
</html>
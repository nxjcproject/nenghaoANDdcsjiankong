...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('/UI_Monitor/images/page/DCS/zc_nxjc_klqc_klqf/zc_nxjc_klqc_klqf_clinker01_shuliaochucun.png'); width: 1483px; height: 731px; overflow: hidden;">
     ...
     <%--贴标签处--%>
        <%--贴标签处--%>
        <%--模拟量开始--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_6501_AR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 103px; left: 554px; position: absolute; color: #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_ZT_6602Z01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 89px; left: 739px; position: absolute; color: #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_6600L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 163px; left: 778px; position: absolute; color: blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_66_37_AR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 654px; left: 53px; position: absolute; color: #4cff00"></div>
        <%--模拟量结束--%>

        <%--开关量开始--%>
        <%--圆形开始--%>
        <div class="BoolSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_M66_30_RD>BoolSignal" data-option="RelatedTags='dcs01_M66_30_RD,dcs01_M66_30_RN,dcs01_M66_30_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'" style="position: absolute; top: 433px; left: 320px; height: 22px; width: 21px;"></div>
        ...
        <%--汉字隐藏开始--%>
        <div id="zc_nxjc_klqc_klqf>dcs01_SCP_6601_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 77px; left: 857px;">故障</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_F_6633_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 404px; left: 196px;">故障</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_F_6600L01_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 178px; left: 1020px;">故障</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_F_6632_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 521px; left: 277px;">故障</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_F_6631_FT>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 605px; left: 400px;">故障</div>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M65_1_LS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 71px; left: 178px;">拉绳</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M65_1_PP1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 71px; left: 232px;">跑偏1</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M65_1_PP2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 71px; left: 293px;">跑偏2</div>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_30_LS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 415px; left: 436px;">拉绳</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_30_PP1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 415px; left: 486px;">跑偏1</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_30_PP2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 415px; left: 568px;">跑偏2</div>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_29_LS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 527px; left: 617px;">拉绳</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_29_PP1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 527px; left: 680px;">跑偏1</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_29_PP2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 527px; left: 738px;">跑偏2</div>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_28_LS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 612px; left: 686px;">拉绳</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_28_PP1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 612px; left: 801px;">跑偏1</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_28_PP2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 612px; left: 910px;">跑偏2</div>
        ...
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_37_LS>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 682px; left: 344px;">拉绳</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_37_PP1>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 682px; left: 388px;">跑偏1</div>
        <div id="zc_nxjc_klqc_klqf>dcs01_M66_37_PP2>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 682px; left: 440px;">跑偏2</div>

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--贴标签处--%>
      <%--贴标签处--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3500L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 252px; left: 149px; position:absolute;color:blue;text-align:right"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3512_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 608px; left: 156px; position:absolute;color:#4cff00;text-align:right"></div>
<%--重--%>
...
<%--重--%>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3512_LJR>DCS'"style="width:45px; height: 18px;display:block; top: 643px; left: 119px; position:absolute;color:#4cff00;text-align:right"></div>   
<%--重--%>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3515_R>DCS'"style="width:45px;display:block; top: 609px; left: 303px; position:absolute;color:#4cff00;text-align:right"></div>   
     
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3515R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 628px; left: 332px; position:absolute;color:#4cff00;text-align:right"></div>
<%--重--%>
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3515_LJR>DCS'"style="width:45px;display:block; top: 647px; left: 303px; position:absolute;color:#4cff00;text-align:right"></div>   
    <%--重--%> 
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3514_R>DCS'"style="width:45px;display:block; top: 609px; left: 497px; position:absolute;color:#4cff00;text-align:right"></div>   
 ...
 <%--重--%>    
         ...
         <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3514_LJR>DCS'" style="width:45px;display:block; top: 643px; left: 499px; position:absolute;color:#4cff00;text-align:right"></div>
     
          <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3513_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 612px; left: 696px; position:absolute;color:#4cff00;text-align:right"></div>
          <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3513R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 631px; left: 696px; position:absolute;color:#4cff00;text-align:right"></div>
<%--重--%>
<%--   <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_F_3513_LJR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 653px; left: 696px; position:absolute;color:#4cff00;text-align:right"></div>--%>
       <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3513_LJR>DCS'" style="width:45px;display:block; top: 650px; left: 667px; position:absolute;color:#4cff00;text-align:right"></div>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_SCP_17_4_LJR>DCS'" style="width:47px; display:block; top: 383px; left: 1174px; position:absolute;text-align:left"></div>
<%--        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_SCP_17_4_LJR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 386px; left: 1203px; position:absolute;color:#4cff00;text-align:right"></div>--%>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_klqc_klqf>dcs01_YLZLJ_PV_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:45px;display:block; top: 466px; left: 1359px; position:absolute;color:#4cff00;text-align:right"></div>
    ...
    <%--重--%>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_klqc_klqf>dcs01_F_3512_R>DCS'" style="width:53px; display:block; top: 640px; left: 1038px; position:absolute;color:#4cff00;text-align:left; height: 17px;"></div>

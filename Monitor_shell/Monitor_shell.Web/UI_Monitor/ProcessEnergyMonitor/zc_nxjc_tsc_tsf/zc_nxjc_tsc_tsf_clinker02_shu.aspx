...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="b/ealib/themes/gray/easyui.css" />
    <link rel="stylesheet" type="text/css" href="b/ealib/themes/icon.css" />
    <link rel="stylesheet" type="text/css" href="b/extlib/themes/syExtIcon.css" />
    <link rel="stylesheet" type="text/css" href="b/extlib/themes/syExtCss.css" />

    <link rel="stylesheet" type="text/css" href="/UI_Monitor/css/common/mymonitor.css" />

    <script type="text/javascript" src="b/ealib/jquery.min.js" charset="utf-8"></script>
    <script type="text/javascript" src="/js/common/jquery.utility.js" charset="utf-8"></script>
    <!--[if lt IE 8 ]><script type="text/javascript" src="/js/common/json2.min.js"></script><![endif]-->

    <script type="text/javascript" src="b/ealib/jquery.easyui.min.js" charset="utf-8"></script>
    <script type="text/javascript" src="b/ealib/easyui-lang-zh_CN.js" charset="utf-8"></script>

    <script src="/UI_Monitor/js/common/monitorjs.js" charset="utf-8"></script>
    <script src="/UI_Monitor/js/commonartjs.js" charset="utf-8"></script>

...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
 ...
 <!--拉链机311.05 -->
         <table class="mytable" style="position: absolute; top: 411px; left: 1018px; height: 53px; right: 266px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine05>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine05>Current" class="mchart nodisplay"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine05>Power" class="mchart"></span></td>
            </tr>
        </table>
 <!--拉链机311.06 -->
        <table class="mytable" style="position: absolute; top: 555px; left: 1019px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine06>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine06>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine06>Power" class="mchart"></span></td>
            </tr>
        </table>
 <!--拉链机311.13 -->
        <table class="mytable" style="position: absolute; top: 464px; left: 1180px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine13>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine13>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine13>Power" class="mchart"></span></td>
            </tr>
        </table>
        <!--拉链机311.14 -->
        <table class="mytable" style="position: absolute; top: 462px; left: 1249px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine14>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine14>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker02>zipperMachine14>Power" class="mchart"></span></td>
            </tr>
        </table>
<!--高温风机油站311.02bAR -->

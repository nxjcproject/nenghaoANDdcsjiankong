...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--标签粘贴处--%>
      ...
      <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LLT01R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 452px; left: 119px; position: absolute; color: blue; text-align: right;"></div>
        <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LLT04R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 453px; left: 191px; position: absolute; color: blue; text-align: right;"></div>
        <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LLT03R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 451px; left: 262px; position: absolute; color: blue; text-align: right;"></div>
        <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LLT02R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 450px; left: 336px; position: absolute; color: blue; text-align: right;"></div>
        <%--模拟量--%>
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_LLT01R>DCS'" style="width:47px; display:block; top: 282px; left: 528px; color: blue; position:absolute;"></div>
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_LLT04R>DCS'" style="width:47px; display:block; top: 282px; left: 763px; color: blue; position:absolute;"></div>
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_LLT03R>DCS'" style="width:47px; display:block; top: 280px; left: 991px; color: blue; position:absolute;"></div>
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_efc>Cement01_LLT02R>DCS'" style="width:47px; display:block; top: 281px; left: 1196px; color: blue; position:absolute;"></div>
        <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_MLT3_05R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 452px; left: 405px; position: absolute; color: blue; text-align: right;"></div>
        <%--模拟量--%>
        ...
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LI6M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 18px; left: 1353px; position: absolute; color: #4cff00; text-align: right;"></div>
        <%--模拟量--%>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_efc>Cement01_LI8M_IR>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 561px; left: 1393px; position: absolute; color: #4cff00; text-align: right;"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_DI1_L19M>BoolSignal" style="position: absolute; top: 187px; left: 535px; height: 21px; width: 24px;" data-option="RelatedTags='Cement01_DI1_L19M,Cement01_DI2_L19M,Cement01_L19M_ALM',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_qtx_efc>Cement01_DI1_L1M>BoolSignal" style="position: absolute; top: 625px; left: 1354px; height: 21px; width: 24px;" data-option="RelatedTags='Cement01_DI1_L1M,Cement01_DI2_L1M,Cement01_L1M_ALM',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <div id="zc_nxjc_qtx_efc>Cement01_DI3_L10ALC>DCS" class="TextDisplay" data-option="Display='1'" style="position: absolute; top: 220px; left: 1190px; color: red; font-size: 12px; right: 266px;">故障</div>
         ...
         <div id="zc_nxjc_qtx_efc>Cement01_DI4_L13M>DCS" class="TextDisplay" data-option="Display='1'" style="position:absolute; top: 84px; left: 1176px; color:#4cff00;font-size:12px;"> 开</div> 
         <div id="zc_nxjc_qtx_efc>Cement01_DI5_L13M>DCS" class="TextDisplay" data-option="Display='1'" style="position:absolute; top: 83px; left: 1293px; color:#4cff00;font-size:12px;"> 关</div> 

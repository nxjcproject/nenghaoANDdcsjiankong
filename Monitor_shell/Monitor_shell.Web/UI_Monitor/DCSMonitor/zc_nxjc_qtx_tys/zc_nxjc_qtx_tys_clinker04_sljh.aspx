...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_clinker04_sljh.png');width: 1558px; height: 807px;  overflow: hidden;">
      ...
      <%--圆形--%>  
         ...
         <div class="BoolSignal mchart" id="zc_nxjc_qtx_tys>dcs01_W22114_RD>BoolSignal" style="position: absolute; top:381px; left: 160px; height: 19px; width: 19px;" data-option="RelatedTags='dcs01_W22114_RD,dcs01_W22114_RN,dcs01_W22114_ERR',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>    
       ...
       <div class="Conflict"  data-option="id='zc_nxjc_qtx_tys>dcs01_W22010cZ01_R>DCS'" style="width:42px;display:block; top: 351px; left: 1364px; position:absolute;color:blue;text-align:right"></div>
        ...
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_tys>dcs01_W22117_OP>DCS'"  style="position:absolute; top: 158px; left: 278px; color:#4cff00;text-align:center;">位置信号</div> 
        <div id="zc_nxjc_qtx_tys>dcs01_W22112_OP>DCS" class="TextDisplay" style="position:absolute; top: 168px; left: 386px; color:#4cff00;text-align:center;">入库</div> 
        <div class="Conflict"  data-option="id='zc_nxjc_qtx_tys>dcs01_W22112_OP>DCS'"  style="position:absolute; top: 168px; left: 95px; color:#4cff00;text-align:center;">位置信号</div> 
        ...
        <div id="zc_nxjc_qtx_tys>dcs01_W220012_OK>DCS" class="TextDisplay" style="position:absolute; top: 184px; left: 1141px; color:#4cff00;text-align:center;">综合器位置</div>
        ...
        <div id="zc_nxjc_qtx_tys>dcs01_T22017AR_FL>DCS" class="TextDisplay" style="position:absolute; top: 299px; left: 1298px; color:red;text-align:center;">卸料阀控制柜故障</div> 

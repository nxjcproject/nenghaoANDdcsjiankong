...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_qtx_tys/zc_nxjc_qtx_tys_clinker04_slccysz.png');width: 1558px; height: 808px;  overflow: hidden; top: 0px; left: 0px;">
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_T3410L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:40px; display:block; top: 195px; left: 742px; position:absolute;color:blue;text-align :right; height: 11px; right: 776px;"></div>

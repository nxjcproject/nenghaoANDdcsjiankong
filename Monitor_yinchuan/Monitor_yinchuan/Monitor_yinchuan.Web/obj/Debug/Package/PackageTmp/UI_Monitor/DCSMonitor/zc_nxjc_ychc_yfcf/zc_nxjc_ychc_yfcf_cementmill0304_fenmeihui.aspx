...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
  ...
  <%--贴标签开始--%>
    <%--邵怡玲--%>   
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_I_84b00L2>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 350px; left: 672px; position:absolute;color:blue;text-align:right;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_I_84b02W123>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 572px; left: 466px; position:absolute;color:#4cff00;text-align:right;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_I_84b06W123>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 572px; left: 652px; position:absolute;color:#4cff00;text-align:right;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_qtx_tys>dcs01_I_84b08IT>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width:46px; display:block; top: 359px; left: 805px; position:absolute;color:#4cff00;text-align:right;"></div>

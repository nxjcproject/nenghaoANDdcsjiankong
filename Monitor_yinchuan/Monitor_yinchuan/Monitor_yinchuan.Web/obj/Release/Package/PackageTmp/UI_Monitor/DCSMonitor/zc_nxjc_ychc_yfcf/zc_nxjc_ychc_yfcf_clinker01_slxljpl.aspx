...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_ychc_yfcf/zc_nxjc_ychc_yfcf_clinker01_slxljpl.png'); width: 1126px; height: 740px; overflow: hidden;">
     ...
     <%--<button onclick="CheckTags()">检查标签</button>--%>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L05_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 235px; left: 39px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L06_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 233px; left: 141px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L07_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 235px; left: 238px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L08_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 235px; left: 339px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L01_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 34px; display: block; top: 565px; left: 43px; position: absolute; color:blue; height: 15px;"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L02_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 567px; left: 139px; position: absolute; color:blue"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L03_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 575px; left: 241px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21000L04_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 40px; display: block; top: 572px; left: 339px; position: absolute; color:  #4cff00"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_13101M_I_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 143px; left: 715px; position: absolute; color:  #4cff00"></div>
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_13101M_S_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 161px; left: 716px; position: absolute; color:  #4cff00"></div>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_11204M_I_R>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="width: 46px; display: block; top: 523px; left: 923px; position: absolute; color:  #4cff00"></div>
        <%--模拟量结束--%>
        ...
        <div class="BoolSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_F_21004M_RN>BoolSignal" data-option="RelatedTags='dcs01_F_21004M_RN',Display='0:arrowYellowDown,1:arrowGreenDown'" style="position: absolute; top: 169px; left: 67px; height: 63px; width: 21px;"></div>

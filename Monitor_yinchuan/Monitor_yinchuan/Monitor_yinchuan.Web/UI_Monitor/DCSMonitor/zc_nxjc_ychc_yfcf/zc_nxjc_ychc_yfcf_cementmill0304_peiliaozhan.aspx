...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_ychc_yfcf/zc_nxjc_ychc_yfcf_cementmill0304_peiliaozhan.png'); width: 1224px; height: 739px; overflow: hidden; top: -38px; left: 96px;">
...
<div class="BoolSignal mchart" id="zc_nxjc_ychc_yfcf>dcs01_D79a02A>BoolSignal" style="position: absolute; top:126px; left: 510px; height: 19px; width: 19px;" data-option="RelatedTags='dcs01_D79a02A',Display=0:grayC,1:greenCB'"></div>    
